...
const countries = [
  ...
  countries.forEach((country) => {
    ...
    return addNewInfos.push(addNew);
});

const findCountry = (countries, proValue) => {
    const findName = countries.find((country) => country.name === proValue);

     if (!findName) return 'Pais não encontrado';
...
const newCountry = {
  ...
  const addNewCountry = (countries, newCountry) => [...countries, newCountry];
